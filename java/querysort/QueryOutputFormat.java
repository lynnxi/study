 ...
 */
public class QueryOutputFormat extends TextOutputFormat<LongWritable,Text> {
  ...
  static class TeraRecordWriter extends LineRecordWriter<LongWritable,Text> {
  ...
  public RecordWriter<LongWritable,Text> getRecordWriter(FileSystem ignored,
                                                 JobConf job,
                                                 String name,
